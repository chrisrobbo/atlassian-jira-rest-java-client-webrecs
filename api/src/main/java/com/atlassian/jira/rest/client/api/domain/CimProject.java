...
public class CimProject extends BasicProject {
	...
	public CimProject(URI self, String key, Long id, String name, Map<String, URI> avatarUris, Iterable<CimIssueType> issueTypes, ProjectCategory projectCategory) {
		super(self, key, id, name, projectCategory);
