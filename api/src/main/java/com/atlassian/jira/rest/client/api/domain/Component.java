...
public class Component extends BasicComponent {
	...
	public Component(URI self, @Nullable Long id, String name, String description, String projectKey, @Nullable Long projectId, BasicUser lead) {
	...
	public Component(URI self, @Nullable Long id, String name, String description, String projectKey, @Nullable Long projectId, BasicUser lead, @Nullable AssigneeInfo assigneeInfo) {
		this(self, id, name, description, projectKey, projectId, lead);
	...
	public boolean equals(Object obj) {
		if (obj instanceof Component) {
			...
			return super.equals(obj)
					&& Objects.equal(this.projectKey, that.projectKey)
	...
	@Override
	public int hashCode() {
		return Objects.hashCode(super.hashCode(), projectKey, projectId, lead, assigneeInfo);
	}
