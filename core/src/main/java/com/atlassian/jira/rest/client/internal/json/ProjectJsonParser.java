...
public class ProjectJsonParser implements JsonObjectParser<Project> {
	...
	public Project parse(JSONObject json) throws JSONException {
        ...
        final ProjectCategory projectCategory = JsonParseUtil.getOptionalJsonObject(json, "projectCategory", projectCategoryJsonParser);
        return new Project(expandos, self, key, id, name, description, lead, uri, versions, components, issueTypes, projectRoles, projectCategory);
	}
