...
public class AsynchronousSearchRestClientTest extends AbstractAsynchronousRestClientTest {
	...
	private void jqlSearchShouldReturnIssueWithDetails(String projectSelf) {
		...
		assertEquals(new BasicProject(resolveURI(projectSelf), "TST", 10000L, "Test Project", new ProjectCategory(
				resolveURI("http://localhost:2990/jira/rest/api/latest/projectCategory/10000"), 10000L, "FIRST", "First Project Category")), issue.getProject());
